...
const (
	...
	// IDs 95–99 were assigned to AuthProviderCreated /
	// AuthProviderUpdated / AuthProviderDeleted /
	// AuthSessionGranted / AuthSessionRevoked under ADR-0005.
	// ADR-0006 retired the broker code that emitted them; the
