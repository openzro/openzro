...
// See more: https://docs.openzro.io/api/resources/routes#list-all-routes
...
// Get get route info
// See more: https://docs.openzro.io/api/resources/routes#retrieve-a-route
...
// See more: https://docs.openzro.io/api/resources/routes#create-a-route
...
// See more: https://docs.openzro.io/api/resources/routes#update-a-route
...
// Delete delete route
// See more: https://docs.openzro.io/api/resources/routes#delete-a-route
