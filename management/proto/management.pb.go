...
var file_management_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x50, 0x6f, 0x72, 0x74, 0x22, 0xa7, 0x02,
	...
	0x6f, 0x6c, 0x69, 0x63, 0x79, 0x49, 0x44, 0x22, 0x38, 0x0a, 0x0e, 0x4e, 0x65, 0x74, 0x77, 0x6f,
...
var file_management_proto_depIdxs = []int32{
	...
	20, // 17: management.OpenzroConfig.stuns:type_name -> management.HostConfig
	24, // 18: management.OpenzroConfig.turns:type_name -> management.ProtectedHostConfig
	20, // 19: management.OpenzroConfig.signal:type_name -> management.HostConfig
	21, // 20: management.OpenzroConfig.relay:type_name -> management.RelayConfig
	22, // 21: management.OpenzroConfig.flow:type_name -> management.FlowConfig
	19, // 22: management.OpenzroConfig.update:type_name -> management.UpdateConfig
	3,  // 23: management.HostConfig.protocol:type_name -> management.HostConfig.Protocol
	48, // 24: management.FlowConfig.interval:type_name -> google.protobuf.Duration
	23, // 25: management.FlowConfig.excludedPorts:type_name -> management.FlowPortFilter
	20, // 26: management.ProtectedHostConfig.hostConfig:type_name -> management.HostConfig
	28, // 27: management.PeerConfig.sshConfig:type_name -> management.SSHConfig
	25, // 28: management.NetworkMap.peerConfig:type_name -> management.PeerConfig
	27, // 29: management.NetworkMap.remotePeers:type_name -> management.RemotePeerConfig
	34, // 30: management.NetworkMap.Routes:type_name -> management.Route
	35, // 31: management.NetworkMap.DNSConfig:type_name -> management.DNSConfig
	27, // 32: management.NetworkMap.offlinePeers:type_name -> management.RemotePeerConfig
	40, // 33: management.NetworkMap.FirewallRules:type_name -> management.FirewallRule
	44, // 34: management.NetworkMap.routesFirewallRules:type_name -> management.RouteFirewallRule
	45, // 35: management.NetworkMap.forwardingRules:type_name -> management.ForwardingRule
	28, // 36: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
