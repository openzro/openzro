...
func (RuleDirection) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_management_proto_enumTypes[1].Descriptor()
}

func (RuleDirection) Type() protoreflect.EnumType {
	return &file_proto_management_proto_enumTypes[1]
}
...
func (RuleAction) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_management_proto_enumTypes[2].Descriptor()
}

func (RuleAction) Type() protoreflect.EnumType {
	return &file_proto_management_proto_enumTypes[2]
}
...
func (HostConfig_Protocol) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_management_proto_enumTypes[3].Descriptor()
}

func (HostConfig_Protocol) Type() protoreflect.EnumType {
	return &file_proto_management_proto_enumTypes[3]
}
...
func (HostConfig_Protocol) EnumDescriptor() ([]byte, []int) {
	return file_proto_management_proto_rawDescGZIP(), []int{14, 0}
}
...
func (DeviceAuthorizationFlowProvider) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_management_proto_enumTypes[4].Descriptor()
}

func (DeviceAuthorizationFlowProvider) Type() protoreflect.EnumType {
	return &file_proto_management_proto_enumTypes[4]
}
...
func (DeviceAuthorizationFlowProvider) EnumDescriptor() ([]byte, []int) {
	return file_proto_management_proto_rawDescGZIP(), []int{24, 0}
}
...
func (x *FirewallRule) Reset() {
	*x = FirewallRule{}
	mi := &file_proto_management_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FirewallRule) Descriptor() ([]byte, []int) {
	return file_proto_management_proto_rawDescGZIP(), []int{34}
}
...
func (x *NetworkAddress) Reset() {
	*x = NetworkAddress{}
	mi := &file_proto_management_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NetworkAddress) Descriptor() ([]byte, []int) {
	return file_proto_management_proto_rawDescGZIP(), []int{35}
}
...
func (x *Checks) Reset() {
	*x = Checks{}
	mi := &file_proto_management_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Checks) Descriptor() ([]byte, []int) {
	return file_proto_management_proto_rawDescGZIP(), []int{36}
}
...
func (x *PortInfo) Reset() {
	*x = PortInfo{}
	mi := &file_proto_management_proto_msgTypes[37]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PortInfo) Descriptor() ([]byte, []int) {
	return file_proto_management_proto_rawDescGZIP(), []int{37}
}
...
func (x *RouteFirewallRule) Reset() {
	*x = RouteFirewallRule{}
	mi := &file_proto_management_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RouteFirewallRule) Descriptor() ([]byte, []int) {
	return file_proto_management_proto_rawDescGZIP(), []int{38}
}
...
func (x *ForwardingRule) Reset() {
	*x = ForwardingRule{}
	mi := &file_proto_management_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ForwardingRule) Descriptor() ([]byte, []int) {
	return file_proto_management_proto_rawDescGZIP(), []int{39}
}
...
func (x *PortInfo_Range) Reset() {
	*x = PortInfo_Range{}
	mi := &file_proto_management_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PortInfo_Range) Descriptor() ([]byte, []int) {
	return file_proto_management_proto_rawDescGZIP(), []int{37, 0}
}
...
const file_proto_management_proto_rawDesc = "" +
	...
	"\fSyncResponse\x12?\n" +
	"\ropenzroConfig\x18\x01 \x01(\v2\x19.management.OpenzroConfigR\ropenzroConfig\x126\n" +
	"\n" +
	...
	"\x10processIsRunning\x18\x03 \x01(\bR\x10processIsRunning\"\xc1\x03\n" +
	"\x05Flags\x12*\n" +
	...
	" \x01(\bR\x15lazyConnectionEnabled\"\xf2\x04\n" +
	...
	"\x0eopenzroVersion\x18\a \x01(\tR\x0eopenzroVersion\x12\x1c\n" +
	...
	"\x0etokenSignature\x18\x03 \x01(\tR\x0etokenSignature\"\xc3\x03\n" +
	"\n" +
	"FlowConfig\x12\x10\n" +
	...
	"\rdnsCollection\x18\b \x01(\bR\rdnsCollection\x12\x16\n" +
	"\x06groups\x18\t \x03(\tR\x06groups\x12:\n" +
	"\x18disableDefaultPortFilter\x18\n" +
	" \x01(\bR\x18disableDefaultPortFilter\x12@\n" +
	"\rexcludedPorts\x18\v \x03(\v2\x1a.management.FlowPortFilterR\rexcludedPorts\"@\n" +
	"\x0eFlowPortFilter\x12\x12\n" +
	...
	"\bpassword\x18\x03 \x01(\tR\bpassword\"\x81\x02\n" +
	"\n" +
	"PeerConfig\x12\x18\n" +
	...
	"\x15LazyConnectionEnabled\x18\x06 \x01(\bR\x15LazyConnectionEnabled\"\xb9\x05\n" +
	"\n" +
	"NetworkMap\x12\x16\n" +
	...
	"\x0fforwardingRules\x18\f \x03(\v2\x1a.management.ForwardingRuleR\x0fforwardingRules\"\xbb\x01\n" +
	...
	"\fagentVersion\x18\x05 \x01(\tR\fagentVersion\"I\n" +
	"\tSSHConfig\x12\x1e\n" +
	"\n" +
	"sshEnabled\x18\x01 \x01(\bR\n" +
	"sshEnabled\x12\x1c\n" +
	"\tsshPubKey\x18\x02 \x01(\fR\tsshPubKey\" \n" +
	...
	"\tLoginFlag\x18\f \x01(\rR\tLoginFlag\"\xed\x01\n" +
	"\x05Route\x12\x0e\n" +
	...
	"\tkeepRoute\x18\t \x01(\bR\tkeepRoute\"\xb4\x01\n" +
	"\tDNSConfig\x12$\n" +
	...
	"\vCustomZones\x18\x03 \x03(\v2\x16.management.CustomZoneR\vCustomZones\"X\n" +
	"\n" +
	"CustomZone\x12\x16\n" +
	"\x06Domain\x18\x01 \x01(\tR\x06Domain\x122\n" +
	"\aRecords\x18\x02 \x03(\v2\x18.management.SimpleRecordR\aRecords\"t\n" +
	...
	"\x0etranslatedPort\x18\x04 \x01(\v2\x14.management.PortInfoR\x0etranslatedPort*L\n" +
	"\fRuleProtocol\x12\v\n" +
	...
	"\bSyncMeta\x12\x1c.management.EncryptedMessage\x1a\x11.management.Empty\"\x00B\bZ\x06/protob\x06proto3"
...
var file_proto_management_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_proto_management_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_proto_management_proto_goTypes = []any{
	...
	(*FlowPortFilter)(nil),                 // 22: management.FlowPortFilter
...
var file_proto_management_proto_depIdxs = []int32{
	...
	23, // 18: management.OpenzroConfig.turns:type_name -> management.ProtectedHostConfig
	...
	22, // 24: management.FlowConfig.excludedPorts:type_name -> management.FlowPortFilter
...
func file_proto_management_proto_init() {
	...
	file_proto_management_proto_msgTypes[37].OneofWrappers = []any{
		(*PortInfo_Port)(nil),
		(*PortInfo_Range_)(nil),
	}
	type x struct{}
