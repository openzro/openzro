...
type InstallOpenzroWithSetupKeyButtonProps = {
  name?: string;
};

const InstallOpenzroWithSetupKeyButton = ({
  name,
}: InstallOpenzroWithSetupKeyButtonProps) => {
  ...
  const createSetupKey = async () => {
    const choice = await confirm({
      ...
      description:
        "If you continue, a one-off setup key will be automatically created and you will be able to install Openzro.",
