      ...
      <DataTable
        ...
        getStartedCard={
          <GetStartedTest
            ...
            description={
              "Add posture checks to further restrict access in your network. E.g., only clients with a specific Openzro client version, operating system or location are allowed to connect."
            }
            button={
              <Button
                variant={"primary"}
