...
type FlowGroup = {
  ...
  // address (e.g. ci.cora.tools) on the destination pill instead of
...
export default function NetworkTrafficTimeline() {
  ...
  // this fetch, a flow to e.g. ci.cora.tools would render the bare
...
// ci.cora.tools) takes precedence over the bare-IP "external" label.
