  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        // zinc-800 dark border reads as a hard line against the
        // elevated surface and visually clashes with the rounded
        // popover.
        "relative z-50 min-w-[8rem] overflow-hidden rounded-md border border-oz2-border bg-white text-neutral-950 shadow-md [outline:none] focus:[outline:none] focus-visible:[outline:none] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 dark:bg-nb-gray dark:text-neutral-50",
        position === "popper" &&
