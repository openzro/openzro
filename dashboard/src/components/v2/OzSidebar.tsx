      ...
      >
        {sections.map((section) => (
          <div key={section.id} className="mb-5">
            {!collapsed && (
              <p className="mb-2 px-3 font-mono text-[12px] uppercase tracking-widest text-oz2-text-faint">
                {section.label}
              </p>
            )}
              ...
              {section.items.map((item) => (
                <li key={item.id}>
                  <button
                    ...
                    className={classNames(
                      "flex h-8 items-center rounded-lg text-[14px] font-medium transition-colors",
                      collapsed
