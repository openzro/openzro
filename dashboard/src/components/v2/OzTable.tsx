...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-x-auto">
    <table
      ref={ref}
      className={classNames("w-full caption-bottom text-[13px]", className)}
      {...props}
    />
  </div>
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={classNames(
      "whitespace-nowrap px-[14px] py-[11px] text-left font-mono text-[10.5px] font-semibold uppercase tracking-widest text-oz2-text-muted",
      className,
    )}
    {...props}
  />
