  ...
  {},
  {
    variants: {
      variant: {
        ...
        important: "from-openzro to-openzro-400 bg-gradient-to-b text-white",
      },
      tagBadge: {
        default: "bg-nb-gray-200/10 text-nb-gray-100 font-medium",
        important: "bg-white text-openzro font-medium",
      },
      closeButton: {
        default:
          "bg-nb-gray-900 rounded-md p-1 text-nb-gray-300 hover:bg-nb-gray-800",
        important:
          "bg-openzro-100 rounded-md p-1 text-openzro-600 hover:bg-white",
      },
      inlineLink: {
