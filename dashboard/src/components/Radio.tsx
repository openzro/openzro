  ...
  variants: {
    variant: {
      default: [
        ...
        "dark:data-[state=checked]:bg-openzro",
      ],
    },
  },
});
  ...
  return (
    ...
    >
      <RadioPrimitive.Indicator asChild={true}>
        <div
          className={cn(
            "h-2 w-2 bg-openzro absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center rounded-full",
