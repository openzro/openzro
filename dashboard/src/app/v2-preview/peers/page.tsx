...
const peers: MockPeer[] = [
  ...
  {
    id: "3",
    name: "routing-peer-prod-1",
    dnsLabel: "routing-peer-prod-1.acme.example.mesh",
    ip: "100.80.2.10",
    publicIp: "198.51.100.4",
    os: "Rocky Linux",
    osVersion: "9.5",
    groups: ["routing-peers", "production", "all"],
    country: "US",
    region: "Iowa, US",
  ...
  {
    id: "4",
    name: "routing-peer-prod-2",
    dnsLabel: "routing-peer-prod-2.acme.example.mesh",
    ip: "100.80.2.11",
