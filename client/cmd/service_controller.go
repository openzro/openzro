...
func (p *program) Start(svc service.Service) error {
	...
	log.Info("starting Openzro service") //nolint
...
func (p *program) Stop(srv service.Service) error {
	...
	log.Info("stopped Openzro service") //nolint
	return nil
}
...
var startCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		cmd.Println("Openzro service has been started")
		return nil
	},
}
...
var stopCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		cmd.Println("Openzro service has been stopped")
		return nil
	},
}
...
var restartCmd = &cobra.Command{
	Use:   "restart",
	Short: "restarts Openzro service",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := context.WithCancel(cmd.Context())
		s, err := setupServiceControlCommand(cmd, ctx, cancel)
		if err != nil {
		...
		cmd.Println("Openzro service has been restarted")
		return nil
	},
}
...
var svcStatusCmd = &cobra.Command{
	Use:   "status",
	Short: "shows Openzro service status",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := context.WithCancel(cmd.Context())
		s, err := setupServiceControlCommand(cmd, ctx, cancel)
		if err != nil {
		...
		cmd.Printf("Openzro service status: %s\n", statusText)
		return nil
	},
}
