...
func (t *TunDevice) Create() (WGConfigurer, error) {
	...
	t.device = device.NewDevice(t.filteredDevice, t.iceBind, device.NewLogger(wgLogLevel(), "[openzro] "))
	// without this property mobile devices can discover remote endpoints if the configured one was wrong.
	// this helps with support for the older Openzro clients that had a hardcoded direct mode
