...
func TestIsBlocked(t *testing.T) {
	cases := []struct {
		...
		{"aws/gcp/azure imds v4", "169.254.169.254", true},
		{"imds v4 as v4-in-v6", "::ffff:169.254.169.254", true},
		{"aws imds v6", "fd00:ec2::254", true},
		{"aws ecs task-credentials metadata", "169.254.170.2", true},
		{"aws eks pod-identity v4", "169.254.170.23", true},
		{"aws eks pod-identity v6", "fd00:ec2::23", true},
		{"ipv4 unspecified (linux connect→loopback)", "0.0.0.0", true},
